export const WSS_CONNECTION_REQUEST:"WSS_CONNECTION_REQUEST" = "WSS_CONNECTION_REQUEST";
export const WSS_CONNECTION_SUCCESS:"WSS_CONNECTION_SUCCESS" = "WSS_CONNECTION_SUCCESS";
export const WSS_CONNECTION_ERROR:"WSS_CONNECTION_ERROR" = "WSS_CONNECTION_ERROR";
export const WSS_CONNECTION_CLOSED:"WSS_CONNECTION_CLOSED" = "WSS_CONNECTION_CLOSED";
